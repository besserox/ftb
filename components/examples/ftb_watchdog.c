...
int main (int argc, char *argv[])
{
    ...
    */
    ...
    while(1) {
        ...
        printf("Received event details: Event space=%s, Severity=%s, Event name=%s, Client name=%s, Hostname=%s, Seqnum=%d\n", caught_event.event_space, caught_event.severity,  caught_event.event_name, caught_event.client_name, caught_event.incoming_src.hostname, caught_event.seqnum);
        /* printf("Received event location: pid=%d and pi=%s\n", caught_event.incoming_src.pid,  caught_event.incoming_src.pid_starttime); */
