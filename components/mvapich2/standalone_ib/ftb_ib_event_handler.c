...
#define FTB_EVENT_IB_EVENT_CQ_ERR 3
#define FTB_EVENT_IB_EVENT_QP_FATAL 4
#define FTB_EVENT_IB_EVENT_QP_REQ_ERR 5
#define FTB_EVENT_IB_EVENT_QP_ACCESS_ERR 6
#define FTB_EVENT_IB_EVENT_PATH_MIG 7
#define FTB_EVENT_IB_EVENT_PATH_MIG_ERR 8
#define FTB_EVENT_IB_EVENT_DEVICE_FATAL 9
#define FTB_EVENT_IB_EVENT_SRQ_ERR 10
#define FTB_EVENT_IB_EVENT_QP_LAST_WQE_REACHED 11
#define FTB_EVENT_IB_EVENT_PORT_ERR 12
#define FTB_EVENT_IB_EVENT_COMM_EST 13
#define FTB_EVENT_IB_EVENT_PORT_ACTIVE 14
#define FTB_EVENT_IB_EVENT_SQ_DRAINED 15
#define FTB_EVENT_IB_EVENT_LID_CHANGE 16
#define FTB_EVENT_IB_EVENT_PKEY_CHANGE 17
#define FTB_EVENT_IB_EVENT_SM_CHANGE 18
#define FTB_EVENT_IB_EVENT_CLIENT_REREGISTER 19
#define FTB_EVENT_IB_EVENT_SRQ_LIMIT_REACHED 20
