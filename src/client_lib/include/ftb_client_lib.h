...
int FTBC_Init(const FTB_comp_info_t *comp_info, uint8_t extension, const FTB_component_properties_t *properties, FTB_client_handle_t *client_handle);
...
int FTBC_Catch(FTB_subscribe_handle_t  shandle, FTB_catch_event_info_t *event);
